...
const MetricsCard = ({ title, subtitle, value, icon: Icon, progress, onClick }) => (
  <div className="flex flex-col rounded-xl border bg-white shadow-sm dark:border-neutral-800 dark:bg-[#13131a]">
    ...
    <a
      className="inline-flex items-center justify-between rounded-b-xl border-t border-gray-200 px-4 py-3 text-sm text-gray-600 hover:bg-gray-50 md:px-5 dark:border-neutral-800 dark:text-neutral-400 transition-colors dark:hover:bg-neutral-800"
      href="#"
      onClick={onClick}
    >
      {subtitle}
